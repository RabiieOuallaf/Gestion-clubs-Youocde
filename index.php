    ...
    <section class="join_us">
        <div class="join_container">
            ...
            <div class="how_to_join">
                <h3>How to Create your own <span>club</span> ?</h3>
                <div class="box_btn">
                    <div class="create_club">
                        <img src="./Sass/images/🦆 icon _edit_.png" alt="">
    ...
    <section class="contact_us">
        <div class="contact_container">
            ...
            <div class="contact_sub_title">
                <h3><span>Do</span> you have any problem ?</h3>
                <div class="form">
                    <form action="">
                        <div>
            ...
            <div class="contact_img">
                <img src="./Sass/images/contact.png" alt="" width="100%">
